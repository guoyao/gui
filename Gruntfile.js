...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            gui: {
                src: ['js/helper.js', 'js/nav.js', 'js/tab.js', 'js/collapse.js', 'js/popup.js', 'js/slider.js', 'js/placeholder.js', 'js/panel.js', 'js/button.js', 'js/datepicker.js', 'js/button-bar.js', 'js/affix.js', 'js/carousel.js' ,'js/ie-patch.js'],
